...
_VIZ_FIELDS = (
    ...
    "visualizer_bars_mode", "visualizer_bars_mirror",
    "visualizer_waveform_mode", "visualizer_waveform_mirror",
)
...
async def start_video_processing(
    ...
    config = {
        ...
        "banner_video_rotation": request.banner_video_rotation,
        ...
        "subtitle_max_width": request.subtitle_max_width,
...
def _preview_config_hash(cfg: dict) -> str:
    ...
    keys = [
        ...
        "banner_video_scale_x", "banner_video_scale_y", "banner_video_rotation", "overlay_opacity",
        ...
        "subtitle_x", "subtitle_y", "subtitle_opacity", "subtitle_max_width",
...
def _run_preview_render(job_hash: str, cfg: dict, output_path: str) -> None:
    ...
    try:
        ...
        result = processor.render_preview(
            ...
            banner_video_rotation=cfg.get("banner_video_rotation", 0.0),
            ...
            subtitle_max_width=cfg.get("subtitle_max_width", 0.9),
            ...
            visualizer_bars_mirror=cfg.get("visualizer_bars_mirror", False),
