...
VOICES = [
    ("hn_female_ngochuyen_full_24k-st", "Thùy Linh 2.0"),
    ("hn_female_ngochuyen_full_48k-fhg", "HN - Thùy Linh"),
    ("hn_male_manhdung_full_24k-st", "Đức Thịnh 2.0 (Beta)"),
    ("hn_male_minhquan_yt_24k-pre", "Quang Huy Pro (Beta)"),
    ("hn_female_nganha_child_22k-vc", "HN - Bảo Ngọc"),
    ("hn_male_minhquan_yt-stable", "HN - Quang Huy"),
    ("hn_male_vietbach_child_22k-vc", "HN - Hữu Nghĩa"),
    ("sg_female_tuongvy_call_44k-fhg", "SG - Khánh Vy"),
    ("hn_female_hachi_book_22k-vc", "HN - Diệu Anh"),
    ("sg_female_thaotrinh_full_44k-phg", "SG - Quỳnh Chi"),
    ("sg_male_chidat_ebook_48k-phg", "SG - Tấn Phát"),
    ("hn_female_hermer_stor_48k-fhg", "HN - Hải Yến"),
    ("hn_female_lenka_stor_48k-phg", "HN - Bích Ngọc"),
    ("hn_male_phuthang_stor80dt_48k-fhg", "HN - Gia Bảo"),
    ("hn_male_manhdung_news_48k-fhg", "HN - Đức Thịnh"),
    ("hn_male_thanhlong_talk_48k-fhg", "HN - Trọng Nhân"),
    ("sg_female_thaotrinh_full_48k-fhg", "SG - Quỳnh Chi (sách)"),
    ("hn_male_phuthang_news65dt_44k-fhg", "HN - Gia Bảo (tin tức)"),
    ("hue_female_huonggiang_full_48k-fhg", "Huế - Xuân Mai"),
    ("hn_female_maiphuong_vdts_48k-fhg", "HN - Yến Nhi"),
    ("sg_female_lantrinh_vdts_48k-fhg", "SG - Thu Hà"),
    ("sg_male_trungkien_vdts_48k-fhg", "SG - Xuân Bách"),
    ("hue_male_duyphuong_full_48k-fhg", "Huế - Việt Hoàng"),
    ("sg_male_minhhoang_full_48k-fhg", "SG - Nam Khánh"),
    ("hn_male_manhdung_news_48k-phg", "HN - Đức Thịnh (QC)"),
]
